...
gradlePlugin {
    plugins {
        register("ui-plugin") {
            id = "ui-plugin"
            implementationClass = "com.free.health.plugins.UiPlugin"
        }
    }
}
...
gradlePlugin {
    plugins {
        register("library-plugin") {
            id = "library-plugin"
            implementationClass = "com.free.health.plugins.LibraryPlugin"
        }
    }
}
...
gradlePlugin {
    plugins {
        register("app-plugin") {
            id = "app-plugin"
            implementationClass = "com.free.health.plugins.AppPlugin"
        }
    }
}
