...
const MIRROR_HEIGHT = MIRROR_WEIGHT / mirror_real_weight;
...
export { MIRROR_WEIGHT, MIRROR_HEIGHT, MIRROR_LEFT, MIRROR_RIGHT, MIRROR_CENTER, BACK_GROUND_COLOR, TEXT_COLOR };
