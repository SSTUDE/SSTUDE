...
export const getWeatherData = async (params: {
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/1360000/VilageFcstInfoService_2.0/getVilageFcst`,
      {
        params: {
...
export const getMidLandForecast = async (params: {
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/1360000/MidFcstInfoService/getMidLandFcst`,
      {
        params: {
          serviceKey: SERVICE_KEY_MINE,
          ...params,
...
export const getMidTemperatureForecast = async (params: {
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/1360000/MidFcstInfoService/getMidTa`,
      {
        params: {
          serviceKey: SERVICE_KEY_MINE,
          ...params,
...
export const getAirQualityData = async (params: {
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty`,
      {
        params: {
          serviceKey: SERVICE_KEY_MINE,
          ...params,
