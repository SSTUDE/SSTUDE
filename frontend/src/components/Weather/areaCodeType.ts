...
const midLandAreaCodes: { [region: string]: MidLandAreaCode } = {
  서울: "11B00000",
  인천: "11B00000",
  경기도: "11B00000",
  강원도: "11D10000",
...
export function getMidLandAreaCode(
  arePt1: string,
  arePt2: string | null
): MidLandAreaCode | null {
  for (let region in midLandAreaCodes) {
    if (
      arePt1.includes(region) ||
      (arePt2 !== null && arePt2.includes(region))
    ) {
      return midLandAreaCodes[region];
    }
  }
  return null;
}
...
export const midTaAreaCode: MidTaAreaCode[] = [
  "11A00101",
  "11B10101",
  "11B10102",
  "11B10103",
